...
const zh: Record<string, string> = {
  ...
  settings_dsh_mem_hint: '通过 NODE_OPTIONS=--max-old-space-size 生效，仅在 node 内存溢出时适当增大',
  settings_show_password: '显示密码',
  settings_hide_password: '隐藏密码',
  // 控制台设置
  console_title: '控制台设置',
  console_desc: '主题、语言与打开时的默认页面。',
  console_theme: '主题',
  console_language: '语言',
  ...
  mem_usage: '内存占用',
  login_list: '登录列表',
  login_list_desc: '访问反向代理服务的客户端，每条会话单独显示，可注销使其重新登录。',
  logout: '注销',
  logging_out: '注销中…',
  last_access: '最近访问',
  expires_at: '登录有效期至',
...
const en: Record<string, string> = {
  ...
  settings_dsh_mem_mb: '(MB)',
  settings_dsh_mem_hint: 'Applied via NODE_OPTIONS=--max-old-space-size; increase only when node runs out of memory',
  settings_show_password: 'Show password',
  settings_hide_password: 'Hide password',
  console_title: 'Console Settings',
  console_desc: 'Theme, language and the default page on open.',
  console_theme: 'Theme',
  ...
  dsh_manage: 'Manage dsh service start, stop and restart.',
  dsh_start: 'Start',
  dsh_stop: 'Stop',
  dsh_restart: 'Restart',
  ...
  login_list_desc: 'Clients accessing the reverse proxy. Each session is shown separately; you can log one out.',
  logout: 'Log out',
